    ...
    movieElm.innerHTML = `
            ...
            <div class="movie-item__meta">
                ...
                <span class="movie-item__meta__imdb-link">
                    <a href="https://www.imdb.com/title/${item.Runtime}" target="_blank">IMDB</a></span>
            </div>`;
...
function showMovieInDetails(movieObj, targetItem) {
    ...
    detailsElm.innerHTML = `
                    ...
                    <div class="movie-details__meta">
                        ...
                        <p>This movie was realeased in ${movieObj.Released} by the ${movieObj.Director} they had directed the movie in very different way and the actors also had done their work to match the audiance expectaion etc etc...<p>
                        </div>`;
